...
| „Wie oft hält er Constraints wirklich ein?“ | [eval_report.md](eval_report.md): 15 Fälle, ternäre programmatische Checks auf Antwort- UND Trajektorien-Ebene (35/41 wertbare Checks = 85 %, 4 neutral; Stand 2026-08-03. Historie: 87 % mit `qwen3-32b` → 80 % nach erzwungenem Modellwechsel → 85 % nach gezielten Mitigationen) — inklusive der ehrlich dokumentierten Fehlschläge. |
