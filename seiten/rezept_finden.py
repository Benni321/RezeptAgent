...
if absenden:
    ...
    # Gericht auf dem Groq-Free-Tier) -- bei bis zu 7 Gerichten (Deckel in
    # wochenplan_workflow.py) sind mehrere Minuten Normalbetrieb, kein Haenger.
    with st.spinner("Der Agent denkt nach (Recherche, ggf. Bildanalyse) — bei einem "
        ...
        try:
            ...
            # Geduldsgrenze dieses Requests. Ein erneuter Versuch mit weniger
            # Gerichten/ohne kcal-Limit ist meist schneller.
